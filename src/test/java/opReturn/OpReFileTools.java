...
public class OpReFileTools {
	...
	private static final String OpRefileName = "opreturn0.byte";
	...
	public opReReadResult readOpReturnFromFileToList(long pointerInFile,int countWanted) throws IOException{
